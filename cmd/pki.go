...
var pkiCmd = &cobra.Command{
	...
	The CA certificate is shipped with the own certificate and private key of an entity (server or node), thus enabling mutual authentication on TLS handshake.
	
	The parameters are to be specified in the configuration file.
